        ...
        if (container !== null && container !== undefined) {
            ...
            function responsiveObserver() {
                ...
                if (findPointActive) {
                    ...
                    if (findPointActive.numberItems)
                        responsiveInit.numberItems = findPointActive.numberItems
                    if (findPointActive.distanceItems)

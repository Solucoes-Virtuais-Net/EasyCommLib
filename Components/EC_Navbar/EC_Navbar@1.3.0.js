class EC_Navbar {
    constructor(navbarRef) {
        ...
        //news
        this.initNavbarFixedHeight = 0;
        this.initNavbarFixedHeightPosition = 0;
        this.initScrollyOnlyNavbarHeight = 0;
        this.navbarRef = navbarRef;
    }
    Config({ logoAlignX, logoAlignY, toolsAlignX, toolsAlignY, responsive, navbarFixed, scrollyOnlyNavbar, scrollyOnlyNavbarPositionX_logo, scrollyOnlyNavbarPositionX_options, scrollyOnlyNavbarPositionX_bottomOptions, scrollyBackground, scrollyBackgroundTop, initNavbarFixedHeight, initNavbarFixedHeightPosition, initScrollyOnlyNavbarHeight }) {
        if (logoAlignX)
        ...
        if (initNavbarFixedHeight)
            this.initNavbarFixedHeight = initNavbarFixedHeight;
        if (navbarFixed)
            this.navbarFixed = navbarFixed;
        if (scrollyOnlyNavbar)
            this.scrollyOnlyNavbar = scrollyOnlyNavbar;
        if (initNavbarFixedHeightPosition)
            this.initNavbarFixedHeightPosition = initNavbarFixedHeightPosition;
        ...
        if (initScrollyOnlyNavbarHeight)
            this.initScrollyOnlyNavbarHeight = initScrollyOnlyNavbarHeight;
